...
# Import checks
test("import openwa_client", lambda: hasattr(__import__("kreativ_notification.notification.openwa_client", fromlist=["get_openwa_settings"]), "get_openwa_settings"))
...
test("import inbound", lambda: hasattr(__import__("kreativ_notification.notification.inbound", fromlist=["handle_incoming_message"]), "handle_incoming_message"))
